...
## [0.7.9] Migrate to PyQt6 and refactor tests

- Refactor codebase to migrate from QtPy to PyQt6
  ([b03f70d](https://github.com/haiiliin/pyqtribbon/commit/b03f70d)).
- Update workflows, dependencies, and documentation for PyQt6 compatibility
  ([4ce8fb6](https://github.com/haiiliin/pyqtribbon/commit/4ce8fb6)).
- Refactor tests.yml to enhance tox environment matrix and improve readability; update panel.py for better widget type handling
  ([95a061b](https://github.com/haiiliin/pyqtribbon/commit/95a061b)).
